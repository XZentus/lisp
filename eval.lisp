...
(defparameter min-val              -20)
(defparameter max-val               20)
...
(defparameter fitness-points      1000)
    ...
    ((listp arg)
     (let ((fun (car arg))
       ...
       (cond
	    ...
	    ((and (numberp arg1) (= arg1 0))      arg2)
	    ((and (numberp arg2) (= arg2 0))      arg1)
            (t                                   `(+ ,arg1 ,arg2))))
         ((eq fun '-)
          (cond
            ((equal arg1 arg2)                    0)
            ((and (numberp arg1) (numberp arg2))  (- arg1 arg2))
	    ((and (numberp arg2) (= arg2 0))      arg1)
	    ((and (numberp arg1) (= arg1 0) (numberp arg2)) (- arg2))
            (t                                   `(- ,arg1 ,arg2))))
         ((eq fun '*)
          (cond
            ((and (numberp arg1) (numberp arg2)) (* arg1 arg2))
	    ...
	    ((and (numberp arg1) (= arg1 -1) (numberp arg2)) (- arg2))
	    ((and (numberp arg2) (= arg2 -1) (numberp arg1)) (- arg1))
            (t                                  `(* ,arg1 ,arg2))))
         ((eq fun '/)
          (cond
            ((or (and (numberp arg1) (= arg1 0))
                 (and (numberp arg2) (= arg2 0))) (error "division by zero"))
            ((equal arg1 arg2)   1)
	    ((and (numberp arg2) (= arg2 1))     arg1)
            ((and (numberp arg1) (numberp arg2)) (/ arg1 arg2))
            (t                                 `(/ ,arg1 ,arg2))))
...
(defparameter target-fun
  (eval `(lambda (x) (+ (sin (* x x 1.46327)) (/ x 0.3423)))))
...
#|
(let* ((f (eval `(lambda ,args-list ,(simplify (car (aref results 0))))))
       (xs (loop for x from fitness-min to fitness-max by fitness-step
                 collect x))
       (ys1 (mapcar (lambda (x) (handler-case
                                    (funcall f x)
                                  (error (e) (declare (ignore e)) exception-weight))) xs))
       (ys2 (mapcar target-fun xs)))
  (vgplot:plot xs ys1 xs ys2))
|#
